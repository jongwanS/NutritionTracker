        ...
        {isFilterVisible && (
          ...
          >
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 w-full">
              {/* Calories Filter */}
              <div className="flex flex-col w-full bg-white p-3 rounded-lg shadow-sm border border-pink-100">
                <div className="flex justify-between items-center mb-1.5">
                  <Label className="text-xs font-semibold text-pink-800 flex items-center">
                    <Flame className="h-3 w-3 mr-1 text-pink-500" />
                    칼로리
                  </Label>
                  <span className="text-xs font-medium bg-gradient-to-r from-pink-500 to-pink-400 text-white px-1.5 py-0.5 rounded">
              ...
              {/* Protein Filter */}
              <div className="flex flex-col w-full bg-white p-3 rounded-lg shadow-sm border border-green-100">
                <div className="flex justify-between items-center mb-1.5">
                  <Label className="text-xs font-semibold text-green-800 flex items-center">
                    <svg className="h-3 w-3 mr-1 text-green-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2">
                  ...
                  <span className="text-xs font-medium bg-gradient-to-r from-green-500 to-green-400 text-white px-1.5 py-0.5 rounded">
              ...
              {/* Carbs Filter */}
              <div className="flex flex-col w-full bg-white p-3 rounded-lg shadow-sm border border-blue-100">
                <div className="flex justify-between items-center mb-1.5">
                  <Label className="text-xs font-semibold text-blue-800 flex items-center">
                    <svg className="h-3 w-3 mr-1 text-blue-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2">
                      <path d="M8 13V12M12 13V10M16 13V8M8 21l4-4 4 4M3 4h18M4 4h16v12a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" />
                    </svg>
                    탄수화물
                  </Label>
                  <span className="text-xs font-medium bg-gradient-to-r from-blue-500 to-blue-400 text-white px-1.5 py-0.5 rounded">
              ...
              {/* Fat Filter */}
              <div className="flex flex-col w-full bg-white p-3 rounded-lg shadow-sm border border-yellow-100">
                <div className="flex justify-between items-center mb-1.5">
                  <Label className="text-xs font-semibold text-yellow-800 flex items-center">
                    <svg className="h-3 w-3 mr-1 text-yellow-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2">
                      <path d="M6 6l12 12M6 18L18 6M12 13.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
                    </svg>
                    지방
                  </Label>
                  <span className="text-xs font-medium bg-gradient-to-r from-yellow-500 to-yellow-400 text-white px-1.5 py-0.5 rounded">
      ...
      {!isFilterVisible && hasActiveFilters && (
        <div className="flex flex-wrap gap-1.5 mt-2">
          {parseInt(filters.calorieRange) > 0 && (
            <div className="bg-gradient-to-r from-pink-500/90 to-pink-400/90 text-white px-2 py-1 text-xs rounded-full shadow-sm border border-pink-200 flex items-center font-medium">
              <Flame className="h-2.5 w-2.5 mr-1" />
              {filters.calorieRange}kcal↓
            </div>
          )}
          {parseInt(filters.proteinRange) > 0 && (
            <div className="bg-gradient-to-r from-green-500/90 to-green-400/90 text-white px-2 py-1 text-xs rounded-full shadow-sm border border-green-200 flex items-center font-medium">
              <svg className="h-2.5 w-2.5 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2">
                <path d="M12 6V2M12 6H7M12 6H17M7 12H5M7 12C7 13.5 9 16.5 12 16.5C15 16.5 17 13.5 17 12M7 12C7 10.5 9 7.5 12 7.5C15 7.5 17 10.5 17 12M17 12H19M12 18V22" />
              </svg>
              {filters.proteinRange}g↑
            </div>
          )}
          {parseInt(filters.carbsRange) > 0 && (
            <div className="bg-gradient-to-r from-blue-500/90 to-blue-400/90 text-white px-2 py-1 text-xs rounded-full shadow-sm border border-blue-200 flex items-center font-medium">
              <svg className="h-2.5 w-2.5 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2">
                <path d="M8 13V12M12 13V10M16 13V8M8 21l4-4 4 4M3 4h18M4 4h16v12a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" />
              </svg>
              {filters.carbsRange}g↓
            </div>
          )}
          {parseInt(filters.fatRange) > 0 && (
            <div className="bg-gradient-to-r from-yellow-500/90 to-yellow-400/90 text-white px-2 py-1 text-xs rounded-full shadow-sm border border-yellow-200 flex items-center font-medium">
              <svg className="h-2.5 w-2.5 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2">
                <path d="M6 6l12 12M6 18L18 6M12 13.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
              </svg>
              {filters.fatRange}g↓
